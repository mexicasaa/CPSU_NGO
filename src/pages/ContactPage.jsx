          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1.2fr', gap: '80px', alignItems: 'center' }} className="office-grid">
                ...
                {[
                  {
                    ...
                    desc: "123 Peace Avenue, Sector 45, New Delhi, India - 110001",
            ...
            <div className="card hover-lift" style={{ 
              ...
              <div style={{ textAlign: 'center', zIndex: 1, padding: '40px' }}>
                ...
                <h3 style={{ fontFamily: "'Playfair Display', Georgia, serif", fontSize: '1.25rem', color: 'var(--bg-main)', marginBottom: '8px', fontWeight: 400 }}>Interactive Map</h3>
                <p style={{ fontSize: '0.85rem', color: 'rgba(245,243,238,0.6)', maxWidth: '280px', margin: 0, lineHeight: 1.5, fontWeight: 300 }}>
