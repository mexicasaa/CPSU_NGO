...
const ROLES = [
  {
    id: 'tutor',
    title: 'Sankalp Education Tutor',
    tag: '3-5 Hours / Week',
    location: 'Local Centers',
    desc: 'Spend a few hours a week teaching foundational literacy and numeracy to primary students at our local centers.',
    icon: (
  ...
  {
    id: 'environment',
    title: 'Afforestation Drive Leader',
    tag: 'Flexible / Weekend',
    location: 'Urban Forests',
    desc: 'Organize and participate in local tree-planting and sapling protection initiatives to restore urban green cover.',
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  {
    id: 'skills',
    title: 'Vocational Skills Facilitator',
    tag: '2-4 Hours / Week',
    location: 'Hunar Centers',
    desc: 'Share your professional expertise by conducting workshops for youth and women looking to build sustainable livelihoods.',
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
  ...
  },
  {
    ...
    tag: 'Flexible / Remote',
    location: 'Community & Digital',
    desc: 'Help organize community townhalls focused on clean water, waste management, and sustainable living practices.',
    icon: (
      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
export default function VolunteerPage() {
  const [formData, setFormData] = useState({ name: '', email: '', phone: '', role: 'tutor', message: '' });
      ...
      <section style={{ 
        ...
        <div className="container" style={{ position: 'relative', zIndex: 2 }}>
          <div style={{ maxWidth: '800px' }}>
            ...
            >
              Direct, selfless service (Seva) is the cornerstone of sustainable social reform. Your hands, skills, and hours can directly uplift a classroom, protect an urban forest, or empower local livelihoods.
            </motion.p>
          </div>
                ...
                <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '24px' }}>
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                    ...
                    <select 
                      ...
                      onBlur={e => e.target.style.borderColor = 'rgba(26,58,42,0.15)'}
                    >
                      <option value="tutor">Sankalp Education Tutor</option>
                      <option value="environment">Afforestation Drive Leader</option>
                      <option value="skills">Vocational Skills Facilitator</option>
                      <option value="campaigns">Awareness Campaigner</option>
